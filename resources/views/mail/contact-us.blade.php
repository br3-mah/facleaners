                            ...
                            <table border="0" cellpadding="30" cellspacing="0" width="100%">
                              <tr>
                                <td align="center" valign="top" class="textContent">
                                  ...
                                  <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#ffffff;line-height:135%;"><b>Service Enquiry</b></h2>
                                    ...
                                    <tr>
                                      <td valign="top" class="textContent">
                                        <h5 style="color:#5F5F5F;">
                                          <span style="color:#2E7D32; font-size:12px;">Service:</span>&nbsp;<b>{{ $data['subject'] }}</b>
                                        </h5>
                                        <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">
                                            ...
                                            <br>
                                            <hr>
                                            <h5 style="color:#00cc88"><b>Customer Information</b></h5>
                                            {{ $data['names'] }}
                                            <br>
                                            {{ $data['email'] }}
                                        </div>
